    ...
    if(isset($_POST['register'])){
        ...
        if($firstname == NULL){
            ...
            if(strlen($file) > 100){
                ...
                $sql = "INSERT INTO user (firstname,midname,lastname,tempat,ttl,nik,warganegara,email,nohp,alamat,pos,file,username,password) VALUES ('$firstname','$midname','$lastname','$tempat','$ttl','$nik','$warganegara','$email','$nohp','$alamat','$pos','$file','$username','$encode_password')";
                ...
                if($upload && $sql){
                    ...
                    $message = 'Try again, Register Failed cause save data have a problem';
